...
public class Venta {
    ...
    public int crearVenta(int idUsuario) {
        ...
        try {
            ...
            String sql = "INSERT INTO ventas(id_usuario, total, fecha) VALUES(?, 0, CONVERT_TZ(NOW(), '+01:00', '-06:00'))";
    ...
    public void finalizarTransaccion(int idVenta, List<DetalleVentaRequest> detalles, double totalFinal) throws SQLException {
        ...
        try {
            ...
            if (idVenta == -1) {
                // Crear nueva venta
                String sqlInsertVenta = "INSERT INTO ventas (id_usuario, total, fecha) VALUES (?, ?, CONVERT_TZ(NOW(), '+01:00', '-06:00'))";
    ...
    public int guardarVentaEnEspera(int idUsuario, double total, List<DetalleVentaEnEspera> detalles) {
        ...
        try {
            ...
            String sql = "INSERT INTO ventas_en_espera (id_usuario, total, fecha) VALUES (?, ?, CONVERT_TZ(NOW(), '+01:00', '-06:00'))";
            PreparedStatement stmt = c.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS);
            stmt.setInt(1, idUsuario);
